  ...
  const renderProfile = () => {
    ...
    return (
      <div className="profile-details-container">
        <img
          src="https://res.cloudinary.com/dtrekraqy/image/upload/v1718258347/dppp_o6j273.jpg"
          alt="profile"
          className="profile-image"
        />
        <h1 className="profile-name">Sai Reddy A</h1>
        <p className="profile-bio">Full Stack Developer | Data Science</p>
      </div>
    )
  }
